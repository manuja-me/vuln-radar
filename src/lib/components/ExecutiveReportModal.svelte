        ...
        <div class="border-b border-[var(--color-hairline)] print:border-neutral-300 pb-5 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div>
            <div class="flex items-center gap-2">
              ...
              <span class="px-1.5 py-0.5 text-[10px] font-mono bg-[var(--color-canvas)] print:bg-neutral-100 text-[var(--color-text-muted)] print:text-neutral-700 rounded-none border border-[var(--color-hairline)] print:border-neutral-300 uppercase tracking-widest">v0.9.0</span>
            </div>
